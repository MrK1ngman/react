...
function Portfolio() {
  ...
  let [filteredListProjects, setFilteredListProjects] = useState(list);
  ...
  function filter(event) {
    ...
    if (select === "All") {  
        setFilteredListProjects(list);  
    } else {
        setFilteredListProjects(list.filter(item => item.category === select));
    }
